...
router.patch('/update',auth.authenticateToken,checkRole.checkRole,(req,res,next)=>{
    let user =req.body;
    var query = "update user set name=?,contactNumber=?,email=?,password=? where id=?";
    connection.query(query,[user.name,user.contactNumber,user.email,user.password,user.id],(err,results)=>{
        if(!err){
